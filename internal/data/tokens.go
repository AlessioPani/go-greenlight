...
func (m *TokenModel) Insert(parentContext context.Context, token *Token) error {
...
func (m *TokenModel) DeleteAllForUser(parentContext context.Context, scope string, userID int64) error {
